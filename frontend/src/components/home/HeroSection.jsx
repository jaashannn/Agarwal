    ...
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
      ...
      <div className="container mx-auto px-4 relative z-10 pt-16">
        <div className="max-w-3xl mx-auto text-center">
          <motion.h1 
            className="text-4xl md:text-6xl font-playfair font-bold text-black mb-4"
          ...
          <motion.h2 
            className="text-2xl md:text-3xl font-playfair italic text-accent mb-6"
            initial={{ opacity: 0, y: 20 }}
            animate={{ opacity: 1, y: 0 }}
      ...
      >
        <div className="text-pink-500 text-sm font-medium mb-2">Scroll Down</div>
        <motion.div 
          className="w-6 h-10 rounded-full border-2 border-pink-500 flex justify-center p-1"
          animate={{ y: [0, 8, 0] }}
