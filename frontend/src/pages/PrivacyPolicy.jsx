          ...
          <div className="max-w-4xl mx-auto">
            <div className="glass-card p-8 md:p-10">
              <div className="prose prose-lg max-w-none prose-headings:font-playfair prose-headings:font-bold prose-headings:text-primary prose-p:text-gray-700">
                ...
                <p>
                  At Aggarwal Matrimonial Punjab, we respect your privacy and are committed to protecting your personal information. This Privacy Policy explains how we collect, use, disclose, and safeguard your information when you use our matrimonial services.
                </p>
                ...
                <p>
               Aggarwal Matrimonial Services, A Unit of Aggarwal Sewa Samiti (Regd.)<br />
Kotkapura 151204, District Faridkot, Punjab, India<br />
Email: aggarwalmatrimonialkkp@gmail.com<br />
Phone: +91 98147 38647 (O.P. Goyal)<br />
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; +91 8360332983 (Bhushan Mittal)<br />
